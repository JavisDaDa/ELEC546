...
fprintf('sift');
trainPath = 'Assignment06_data_expanded/TrainingDataset';
...
%using vobulary tree clustering 
fprintf('cluster');
N = 3000;
treeDepth = 6;
...
fprintf('predict')
testPath = 'Assignment06_data_expanded/TestDataset_';
