...
%%%%%%%%%%%%%%
%1. Bag of Features Classification withpi SIFT Descriptors
run('vlfeat-0.9.21/toolbox/vl_setup');

fprintf('sift');
trainPath = 'Assignment06_data_reduced/TrainingDataset';
...
%do the test and plot confusion matrix
fprintf('predict')
testPath = 'Assignment06_data_reduced/TestDataset_';
